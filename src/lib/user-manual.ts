    ...
    blocks: [
      {
        ...
        items: [
          ...
          "Backup & restore — download the database regularly; restore only when you intend to replace current data.",
        ],
      },
      {
        type: "tip",
        text: "Keep backups on a USB drive or cloud folder after each busy day.",
      },
    ],
  },
  {
    ...
    blocks: [
      {
        ...
        items: [
          ...
          "Super Admin (periodically): take a backup.",
        ],
      },
    ],
  },
